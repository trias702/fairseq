...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lower", action='store_true', help="Whether to lowercase the vocab"
    )
    ...
    binary = os.path.join(args.kenlm, "bin", "build_binary")
    os.system(
        ("{bin} {farpa}.tmp {fbin}" if args.lower else "{bin} {farpa} {fbin}").format(
